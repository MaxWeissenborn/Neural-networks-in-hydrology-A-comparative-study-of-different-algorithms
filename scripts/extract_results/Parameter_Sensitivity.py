...
import spotpy
import pandas as pd
from scripts.custom_functions.general import path_join, load_yaml_file, make_dir, clean_up
import h5py
import pickle
...
def main():
    ...
    test_df_dict = {"+ESF": "preprocessing/output/+ESF - NO NA - VALIDATION NOT FOR TRAIN - Complete"
                           " River Data as Dataframe - 1997 - 2002.pkl",
                    "-SF": "preprocessing/output/-SF - NO NA - VALIDATION NOT FOR TRAIN - Complete"
                           " River Data as Dataframe - 1997 - 2002.pkl"}
    ...
    for row in best_models.itertuples():
        ...
        metric_features = ['et_mm', 'prec_mm', 'soil_temp', 'area_m2_watershed',
                           ...
                           'et_mean', 'prec_mean', 'runoff_ratio']
